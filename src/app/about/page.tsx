  ...
  return (
    <>
      <div className="px-6 py-10 mt-20 md:px-20 lg:px-36">
        ...
        <p className="mt-4 text-xl md:text-2xl lg:text-3xl font-alegreya">
          I have worked on both personal and collaborative projects. Data mining/visualization of several online datasets using Python, applying machine learning techniques such as clustering, classification, and regression. As part of a team, we built a Student-Tutor Management App (Django, PostgreSQL, Tailwind), a Boxing Gym website (React), a To-Do List app (React). These projects have helped me develop strong programming skills while honing key soft skills like teamwork, communication, organization, and time management.
        </p>
